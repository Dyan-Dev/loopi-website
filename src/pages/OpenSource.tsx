        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center px-6 py-3 rounded-lg bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-colors"
            >
            ...
            <Link
              to="/downloads"
              className="inline-flex items-center px-6 py-3 rounded-lg border-2 border-neutral-300 dark:border-neutral-700 hover:border-neutral-400 dark:hover:border-neutral-600 transition-colors"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="p-8 bg-neutral-50 dark:bg-neutral-900 rounded-xl">
            ...
            <h3 className="text-lg mb-3">Download & Install</h3>
