...
2. Post in [GitHub Discussions](https://github.com/Dyan-Dev/loopi/discussions)
...
- **Variables**: Explore the [Variable System](/docs/variables) guide for type detection and access patterns
