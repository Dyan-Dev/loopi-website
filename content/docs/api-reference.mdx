---
title: API Reference
description: Complete reference for Automa's automation step types and executor API
---

# API & Executor Reference

This page documents Automa's automation step types and the main executor API.
...
- Read [Developer Guide](/docs/developer-guide) to extend Automa
