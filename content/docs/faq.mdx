---
title: FAQ
description: Frequently asked questions about Automa
---

# Frequently Asked Questions

Common questions and answers about using Automa.

## General Questions

### What is Automa?

Automa is a free, open-source visual browser automation platform. It lets you create browser automations using a drag-and-drop interface without writing code.

### Is Automa really free?

Yes! Automa is 100% free and open source under the MIT license.

### What platforms does Automa support?
...
No. Automa is designed for visual automation without coding. However, basic understanding of web pages (HTML, CSS selectors) helps create more reliable automations.

## Installation & Setup

### How do I install Automa?
...
### Can I install Automa without Git?
...
4. Automa generates a CSS selector
...
### How can I contribute to Automa?
...
Report bugs on [GitHub Issues](https://github.com/Dyan-Dev/automa/issues). Include:
- Automa version
- Operating system
- Steps to reproduce
...
Open a feature request on [GitHub Discussions](https://github.com/Dyan-Dev/automa/discussions). Describe:
- What you want to do
- Why it's useful
- Example use cases
...
### Does Automa work on slow internet?
...
### What's the maximum page size Automa can handle?
...
Manually close with `browser:close` IPC call or restart Automa.

## Security & Privacy

### Is my data safe?

Yes. Automa runs locally on your machine. No data is sent to external servers unless you explicitly use API Call steps.
...
Yes! Use [GitHub Discussions](https://github.com/Dyan-Dev/automa/discussions) to:
- Ask questions
- Share automations
- Request help
- Discuss features
...
### What license is Automa under?

MIT License – free to use, modify, and distribute.

### Can I use Automa commercially?
...
- Ask in [GitHub Discussions](https://github.com/Dyan-Dev/automa/discussions)
