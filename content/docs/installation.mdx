...
description: Setup, package, and distribute Automa for different platforms
---

# Installation & Building

This guide covers installing Automa for development and packaging it for distribution.
...
This starts Automa in development mode with:
...
Automa uses **electron-forge** to create platform-specific installers and packages.
...
cask "automa" do
  ...
  url "https://github.com/Dyan-Dev/automa/releases/download/v#{version}/Automa-#{version}.dmg"
  name "Automa"
  desc "Visual Browser Automation"
  homepage "https://github.com/Dyan-Dev/automa"
