---
title: Usage Guide
description: Learn how to build and run automations with Automa's visual editor
---

# Usage Guide

This page covers how to use Automa to create, run, and debug browser automations.

## The Automation Builder

The Automation Builder is Automa's visual node-based editor for creating workflows.

### Creating a New Automation

1. From the dashboard, click **"New Automation"**
2. Enter a name and optional description
3. The visual editor opens with an empty canvas
...
Selectors tell Automa which elements to interact with.
...
5. Automa generates a CSS selector automatically
...
Open DevTools in the main Automa window:
...
Need help? Check the [FAQ](/docs/faq) or ask in [GitHub Discussions](https://github.com/Dyan-Dev/automa/discussions).
